...
class TestWinTypeaheadDuringResponseReal(unittest.TestCase):
    def test_typeahead_during_response_is_not_lost(self) -> None:
        ...
        turn2 = f"Turn2 ({token}): Reply with exactly the word OK."
