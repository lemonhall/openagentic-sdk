...
class TestWinBackspaceCjkInputReal(unittest.TestCase):
    def test_backspace_on_cjk_deletes_one_character(self) -> None:
        ...
        typed = f"CJK({token}) 中文X"
        expected = f"CJK({token}) 中文Y"
